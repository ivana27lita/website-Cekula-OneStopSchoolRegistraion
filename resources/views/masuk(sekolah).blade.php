    ...
    @section('tengah')
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                @endif
                <form action="/cekula/loginsekolah" method="POST">
                    @csrf
                    <div class="mb-3 mt-3">
                    ...
                    <div class="mb-3">
                        <label for="password" class="form-label" style="color:aliceblue"><b>Password:</b></label>
                    ...
                    <br>
                        ...
                        <p style="color:white;text-align:center"><a href="/cekula/Daftarsekolah" class="linkdaftar">Belum Punya Akun ?</a></p>
